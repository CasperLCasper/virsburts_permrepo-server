...
function getOperatorWallet(provider) {
    if (!OPERATOR_PRIVATE_KEY) {
        throw new Error('OPERATOR_PRIVATE_KEY nav konfigurēts');
    }
...
app.get('/api/github/login', (req, res) => {
    ...
    if (!GITHUB_REDIRECT_URI) {
        return res.status(500).json({
            success: false,
            error: 'GITHUB_REDIRECT_URI nav konfigurēts'
        });
    }
...
app.post('/api/prepare-backup', async (req, res) => {
    try {
                ...
                try {
                    ...
                    if (manifestResponse.ok) {
                        ...
                        console.log(
                            ...
                            Object.keys(previousPaths).length,
                            'faili,',
         ...
         * ========================================================
         *
         * Cena tiek iegūta no Turbo SDK.
         *
         * Nav manuāli hardkodēta Turbo cena.
         */
        ...
        try {
            ...
            console.warn(
                'Neizdevās iegūt ETH cenu:',
                errorMessage(e)
            );
        }

        const costWei =
            ethers.parseEther(costEth);
...
app.post('/api/execute-backup', async (req, res) => {
    try {
        ...
        /* ========================================================
           2. IESNIEDZ TREASURY TRANSACTION TURBO PAYMENT SERVICE
           ======================================================== */

        console.log(
            'Turbo funding transaction iesniegšana...'
        );
        ...
        console.log(
            '✅ Turbo funding transaction iesniegts:',
            fundResult
        );


        /* ========================================================
           3. PAGAIDA TURBO PAYMENT APSTRĀDI
           ======================================================== */

        console.log(
            'Gaida Turbo payment apstrādi...'
        );
        ...
        console.log(
            'Turbo payment gaidīšanas periods pabeigts'
        );
